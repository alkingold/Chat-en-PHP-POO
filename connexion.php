...
$title = 'Connexion | Un chat en PHP OO';

$description = 'Sur cette page vous pouvez vous connecter pour participer au chat en PHP OO';
...
$form->submit('Se connecter', 'connexion');
